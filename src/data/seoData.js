...
const SEO_GENERAL_DATA = {
    address: {
        "@type": "PostalAddress",
        "streetAddress": "Сухумское шоссе, 1А",
        "addressLocality": "село Кабардинка",
...
export const jsonLDMainPage = [
    {
        ...
        "@type": "WebSite",
        "name": "Шикарный вид",
        "description": `База отдыха Шикарный вид в Кабардинке, предназначена для шикарного отдыха и приятных воспоминаний. 
    ...
    },
    {
        "@context": "https://schema.org",
        "@type": "WebPage",
        "name": "База отдыха с шикарным видом - Шикарный вид",
        "url": HOTEL_LINK,
        "breadcrumb": {
            "@type": "BreadcrumbList",
            "itemListElement": [
...
export const jsonLDHotelsPage = [
    {
        "@context": "https://schema.org",
        "@type": "WebPage",
        "name": "База отдыха Шикарный вид и другие наши отели",
    ...
    return [
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Список номеров в Шикарный вид",
            "description": "Выбирайте и бронируйте номера в Кабардинке. Сравните цены, количество комнат и вместимость для идеального отдыха у моря.",
        ...
        },
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Выбор номеров в Шикарный вид",
            "url": `${HOTEL_LINK}/reservation`,
            "breadcrumb": {
                "@type": "BreadcrumbList",
                "itemListElement": [
...
export const jsonLDContactsPage = [
    {
        "@context": "https://schema.org",
        "@type": "ContactPage",
        "name": "Шикарный вид - Контактная информация",
        "description": `Контакты базы отдыха Шикарный вид в Кабардинке. ${DEFAULT_CONTACTS.address},  ${DEFAULT_CONTACTS.phoneRU} для бронирования и обслуживания гостей.`,
...
export const jsonLDTrackCurPage = [
    {
        "@context": "https://schema.org",
        "@type": "WebSite",
        "name": "Путь до базы отдыха Шикарный вид",
        "description": "Путь на автомобиле до базы отдыха Шикарный вид.",
        "url": `${HOTEL_LINK}/contacts/track/car`,
        "address": SEO_GENERAL_DATA.address,
        "geo": SEO_GENERAL_DATA.geo,
        "telephone": SEO_GENERAL_DATA.telephone,
        "image": `${HOTEL_LINK}/previeImg.jpg`,
        ...
        "breadcrumb": {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Путь до базы отдыха Шикарный вид",
                    "item": `${HOTEL_LINK}/contacts/track/car`,
                },
            ]
        }
    }
...
// страница пути до Бор О Дача (как добраться до отеля)
export const jsonLDTrackBusPage = [
    {
        "@context": "https://schema.org",
        "@type": "WebSite",
        "name": "Путь до базы отдыха Шикарный вид",
        "description": "Путь на общественном транспорте до базы отдыха Шикарный вид.",
...
export const jsonLDTrackBackToPage = [
    {
        "@context": "https://schema.org",
        "@type": "WebSite",
        "name": "Выезд в поселок Кабардинка",
        "description": "Выезд в поселок Кабардинка с базы отдыха Шикарный вид пешком и на автомобиле.",
        "url": `${HOTEL_LINK}/contacts/track/backTo`,
        "address": SEO_GENERAL_DATA.address,
        "geo": SEO_GENERAL_DATA.geo,
        "telephone": SEO_GENERAL_DATA.telephone,
        "image": `${HOTEL_LINK}/previeImg.jpg`,
        ...
        "breadcrumb": {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Выезд в поселок Кабардинка",
                    "item": `${HOTEL_LINK}/contacts/track/backTo`,
                },
            ]
        }
    }
    ...
    return [
        {
            "@context": "https://schema.org",
            "@type": "FAQPage",
            "name": "Часто задаваемые вопросы о базе отдыха Шикарный вид",
