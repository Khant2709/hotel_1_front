...
export default async function Home() {
  ...
  const grouped = hotelImages.reduce((acc, img) => {
        ...
        if (img.image_type === "aboutUs" && !acc.aboutUs) acc.aboutUs = img;
      ...
      {banner: null, mainTerritory: null, territory: [], aboutUs: null}
  );
      ...
      <>
        ...
        <FullWidthWrapper>
          ...
          <CenteredWrapper>
            ...
            <TerritoryView territory={territory} imageMain={grouped.mainTerritory} images={grouped.territory}/>
            <DescriptionView description={description} image={grouped.aboutUs}/>
